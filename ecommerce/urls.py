...
urlpatterns = [
    ...
    path('customer-search', views.customer_search_view,name='customer-search'),
    ...
    path('customer-product-detail',views.customer_product_detail_view,name='customer-product-detail'),
    ...
    path('customer-add-to-cart/<int:pk>', views.customer_add_to_cart_view,name='customer-add-to-cart'),
    path('cart', views.cart_view,name='cart'),
    path('customer-cart', views.customer_cart_view,name='customer-cart'),
    path('remove-from-cart/<int:pk>', views.remove_from_cart_view,name='remove-from-cart'),
    path('customer-remove-from-cart/<int:pk>', views.customer_remove_from_cart_view,name='customer-remove-from-cart'),

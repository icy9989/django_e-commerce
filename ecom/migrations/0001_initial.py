# Generated by Django 3.0.5 on 2022-10-20 00:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=True, on_delete=django.db.models.deletion.CASCADE, to='ecom.Category')),
                ('size_variant', models.ManyToManyField(blank=True, to='ecom.SizeVariant')),
            ],
        ),
        migrations.CreateModel(
            name='Orders',
